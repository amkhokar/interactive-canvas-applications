...
let defaultColorString = "red";
let defaultColorString2 ="blue";
let defaultAnimation = function(){
    soundMaker(defaultColorString, defaultColorString2);
  }

  // defaultAnimation();
  // defaultDrawingMaker("white");
  soundMaker("rgba(255, 255, 255, 0.1)", "black");
  // linearMaker(colorArrayTransparent[5], 50);
  // randomMaker(colorArrayTransparent[5], 50);
  // whiteMaker();
  // eraserMaker();
  // windMillMaker();
  // defaultDrawingMaker();
  ...
  $(document).ready(function () {
    ...
    SoundPanels["3"] = new SoundPanel({
      ...
      control: () => {
          defaultAnimation = function(){soundMaker(colorArrayTransparent[2], colorArray[1]);      
        }
      }
    });
    ...
    SoundPanels["4"] = new SoundPanel({
      ...
      control: () => {
          defaultAnimation = function(){soundMaker(colorArrayTransparent[3], colorArray[2]);      
        }
      }
    });
    ...
    SoundPanels["5"] = new SoundPanel({
      ...
      control: () => {
          defaultAnimation = function(){soundMaker(colorArrayTransparent[4], colorArray[3]);      
        }
      }
    });
    ...
    SoundPanels["6"] = new SoundPanel({
      ...
      control: () => {
          defaultAnimation = function(){soundMaker(colorArrayTransparent[5], colorArray[4]);      
        }
      }
    });
    ...
    SoundPanels["7"] = new SoundPanel({
      ...
      control: () => {
          defaultAnimation = function(){soundMaker(colorArrayTransparent[5], colorArray[0]);      
        }
      }
    });
